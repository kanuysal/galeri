...
if lb_start != -1:
    with open("d:/minadesign/github/antigravity/SERKAN/game/assets/debug_lb.js", "w", encoding="utf-8") as out:
        out.write(content[lb_start:lb_end])
    print("Exported class Lb to debug_lb.js")
else:
    print("Lb not found")
