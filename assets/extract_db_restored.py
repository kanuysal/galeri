...
file_path = "d:/minadesign/github/antigravity/SERKAN/game/assets/index-845b001d_restored.js"
...
if db_start != -1:
    with open("d:/minadesign/github/antigravity/SERKAN/game/assets/debug_db_restored.js", "w", encoding="utf-8") as out:
        out.write(content[db_start:db_end])
    print("Exported class db to debug_db_restored.js")
else:
    print("db not found")
